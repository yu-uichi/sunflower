...
<body>
	...
	<div class="container">
		...
		<div class = "pcUser">
			...
			<br>
			<!-- PCユーザ用UI ------------------------------------------------------------>
			<div class="video_container_PC">
				<div class="video_box">
					<video width="355" height="200" id="video_01" style="margin:0px 0px 4px 0px;" autoplay="true" webkit-playsinline></video>
					<br>
					動画拡大:<input type="checkbox" id="input_01_big" style="width:355px;">
				</div>
				<div class="video_box">
					<video width="355" height="200" id="video_02" style="margin:0px 0px 4px 0px;" autoplay="true" webkit-playsinline></video>
					<br>
					動画拡大:<input type="checkbox" id="input_02_big" style="width:355px;">
				</div>
				<div class="video_box">
					<video width="355" height="200" id="video_03" style="margin:0px 0px 4px 0px;" autoplay="true" webkit-playsinline></video>
					<br>
			...
			<!-- スマホユーザ用UI ------------------------------------------------------------>
			<div class="video_container_phone">
			...
			<img src="" width="0" height="0" alt="" id="tyumoku1">
			<img src="" width="0" height="0" alt="" id="tyumoku2">
...
// var video_phone1 = document.getElementById("video_phone_01");
// var video_phone2 = document.getElementById("video_phone_02");
// var video_phone3 = document.getElementById("video_phone_03");
video.volume = 0;
video2.volume = 0;
video3.volume = 0;
//bgm
document.getElementById("bgm").src = "./../BGM/"+"ongen"+video_number+".mp3";
//画像表示部分
...
$(function(){
    ...
    if($ua.indexOf('iPhone') > 0 || $ua.indexOf('iPad') > 0 || $ua.indexOf('iPod') > 0 || $ua.indexOf('android') > 0 || $ua.indexOf('BlackBerry') > 0 || $ua.indexOf('windows Phone') > 0 || $ua.indexOf('NOKIA') > 0 || /Mobile.*Firefox/.test($ua)){
			...
			//スマホユーザ用のUI
			// $('.phoneUser').show();
			$('.video_container_phone').show();
			$('.pcUser').show();
		} else {//PCユーザ用のUI
			$('.video_container_PC').show();
    	$('.pcUser').show();
    }
});
...
var audio_ = "./../narration/narration"+video_number+"/"+folder_count+".MP3";
...
function video_change(){
	video.src = "./../videos/videos"+video_number+"/No." +folder_count+ "/1.mp4";
	...
	// if(status == "200"){
	// 	video2.src = "./../videos/videos"+video_number+"/No." +folder_count+ "/2.mp4";
	// 	// video_phone_02.src = "./../videos/videos"+video_number+"/No." +folder_count+ "/2.mp4";
	// 	video2.height = 200;
	// 	video2.width = 355;
	// 	// console.log("あるよ");
	// }else{
	...
	// if(status == "200"){
	// 	video3.src = "./../videos/videos"+video_number+"/No." +folder_count+ "/3.mp4";
	// 	// video_phone_03.src = "./../videos/videos"+video_number+"/No." +folder_count+ "/3.mp4";
	// 	video3.height = 200;
	// 	video3.width = 355;
	// 	// console.log("あるよ");
	// }else{
...
function img_change(){
	...
	var filePath2 = "./../videos/videos_img"+video_number+"/tyumoku" + folder_count+".png";
	var xhr;
	xhr = new XMLHttpRequest();
	xhr.open("HEAD", filePath2, false);
	xhr.send(null);
	...
	console.log(status);
	if(status == "200"){
		document.getElementById("tyumoku1").src = "./../videos/videos_img"+video_number+"/tyumoku" + folder_count+".png";
